...
// Tambahkan filter untuk bidangDokumen = 'Seksi Pemerintahan'
$conditions[] = "bidangDokumen = 'Seksi Pemerintahan'";
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tabel Dokumen Seksi Pemerintahan</h4>
