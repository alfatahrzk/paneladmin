...
if (isset($_POST['submit'])) {
    ...
    $target_dir = "assets/dokument/sub_bagian_umum_dan_kepegawaian/";
    ...
    if (!$error && (!isset($_FILES['fileDokumen']) || $_FILES['fileDokumen']['error'] == UPLOAD_ERR_NO_FILE)) {
        ...
        $file_name_new = bin2hex(random_bytes(16)) . '-sub_bagian_umum_dan_kepegawaian.' . $file_type;
            ...
            if (move_uploaded_file($_FILES['fileDokumen']['tmp_name'], $target_file)) {
                ...
                if (mysqli_stmt_execute($stmt)) {
                    ...
                    echo "<script>
                        ...
                        window.location.href='?req=bidang&pages=umum';
                    </script>";
                    exit;
                } else {
                    unlink($target_file);
...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Tambah Dokumen Sub Bagian Umum dan Kepegawaian</h4>
            <p class="card-description">Formulir untuk menambahkan dokumen baru ke Sub Bagian Umum dan Kepegawaian.</p>
            <?php if ($error): ?>
            ...
            <form class="forms-sample" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="tahunDokumen" name="tahunDokumen" placeholder="Masukkan Tahun (YYYY)" min="2000" max="2095" value="<?= htmlspecialchars($tahunDokumen) ?>" required>
                </div>
                <div class="form-group">
