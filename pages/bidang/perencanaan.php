...
// Tambahkan filter untuk bidangDokumen = 'Sub Bagian Perencanaan Evaluasi dan Keuangan'
$conditions[] = "bidangDokumen = 'Sub Bagian Perencanaan Evaluasi dan Keuangan'";
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tabel Dokumen Sub Bagian Perencanaan Evaluasi dan Keuangan</h4>
