...
// Tambahkan filter untuk bidangDokumen = 'Seksi Pembangunan dan Pemberdayaan Masyarakat'
$conditions[] = "bidangDokumen = 'Seksi Pembangunan dan Pemberdayaan Masyarakat'";
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tabel Dokumen Seksi Pembangunan dan Pemberdayaan Masyarakat</h4>
