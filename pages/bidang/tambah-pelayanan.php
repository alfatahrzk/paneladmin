...
if (isset($_POST['submit'])) {
    ...
    $target_dir = "assets/dokument/sub_bagian_pelayanan_publik/";
    ...
    if (!$error && (!isset($_FILES['fileDokumen']) || $_FILES['fileDokumen']['error'] == UPLOAD_ERR_NO_FILE)) {
        ...
        $file_name_new = bin2hex(random_bytes(16)) . '-sub_bagian_pelayanan_publik.' . $file_type;
            ...
            if (move_uploaded_file($_FILES['fileDokumen']['tmp_name'], $target_file)) {
                ...
                if (mysqli_stmt_execute($stmt)) {
                    ...
                    echo "<script>
                        ...
                        window.location.href='?req=bidang&pages=pelayanan';
                    </script>";
                    exit;
                } else {
                    unlink($target_file);
...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Tambah Dokumen Seksi Pelayanan Publik</h4>
            <p class="card-description">Formulir untuk menambahkan dokumen baru ke Seksi Pelayanan Publik.</p>
            <?php if ($error): ?>
