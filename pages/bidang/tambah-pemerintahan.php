...
if (isset($_POST['submit'])) {
    ...
    $target_dir = "assets/dokument/seksi_pemerintahan/";
    ...
    if (!$error && (!isset($_FILES['fileDokumen']) || $_FILES['fileDokumen']['error'] == UPLOAD_ERR_NO_FILE)) {
        ...
        $file_name_new = bin2hex(random_bytes(16)) . '-seksi_pemerintahan.' . $file_type;
            ...
            if (move_uploaded_file($_FILES['fileDokumen']['tmp_name'], $target_file)) {
                ...
                if (mysqli_stmt_execute($stmt)) {
                    ...
                    echo "<script>
                        ...
                        window.location.href='?req=bidang&pages=pemerintahan';
                    </script>";
                    exit;
                } else {
                    unlink($target_file);
...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Tambah Dokumen Seksi Pemerintahan</h4>
            <p class="card-description">Formulir untuk menambahkan dokumen baru ke Seksi Pemerintahan.</p>
            <?php if ($error): ?>
