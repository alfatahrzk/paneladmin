...
// Tambahkan filter untuk bidangDokumen = 'Seksi Ketentraman dan Ketertiban Umum'
$conditions[] = "bidangDokumen = 'Seksi Ketentraman dan Ketertiban Umum'";
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tabel Dokumen Seksi Ketentraman dan Ketertiban Umum</h4>
                ...
                <form action="" method="get">
                    <div class="row g-2 align-items-center mb-3">
                        <div class="col-auto">
                            ...
                            <input class="form-control form-control-sm" name="search" type="text" placeholder="Cari Nama Dokumen" aria-label="Cari Dokumen" value="<?= htmlspecialchars($search_dokumen) ?>">
                        </div>
                        <div class="col-auto">
                            <input class="form-control form-control-sm" name="date" type="date" aria-label="Tanggal Dokumen" value="<?= htmlspecialchars($search_date) ?>">
                        </div>
                        <div class="col-auto">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            if (!empty($surat_masuk)) {
                                ...
                                echo "<tr><td colspan='7' class='text-center'>Tidak ada data Surat Masuk yang cocok dengan kriteria Anda.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            if (!empty($surat_keluar)) {
                                foreach ($surat_keluar as $row) {
                                    ...
                                    echo "<a href='$file_path_dok' class='btn btn-primary btn-sm' target='_blank'>Lihat</a> ";
                                    echo "<a href='$file_path_dok' class='btn btn-success btn-sm'>Download</a>";
                                    echo "</td>
                                          </tr>";
                                }
                            } else {
                                echo "<tr><td colspan='7' class='text-center'>Tidak ada data Surat Keluar yang cocok dengan kriteria Anda.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
