...
// Tambahkan filter untuk bidangDokumen = 'Sub Bagian Umum dan Kepegawaian'
$conditions[] = "bidangDokumen = 'Sub Bagian Umum dan Kepegawaian'";
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tabel Dokumen Sub Bagian Umum dan Kepegawaian</h4>
